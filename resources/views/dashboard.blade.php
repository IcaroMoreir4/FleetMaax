  ...
  <div class="relative flex flex-1">
    ...
    <div id="main-header" class="flex flex-col flex-1 ml-20">
      ...
      <main class="flex-1 p-4">
        <picture class="grid items-center justify-center w-full mb-8">
          <img class="w-[120rem]" src="{{ asset('assets/images/bgDashBoard.png') }}" alt="">
        </picture>

        <!-- Estatísticas de Motoristas -->
        <div class="mb-8">
          <h2 class="text-2xl font-bold text-white mb-4">Motoristas</h2>
          <div class="flex justify-center gap-8 w-[100rem]">
            <div class="bg-white p-3 rounded shadow-2xs w-full min-h-full">
              ...
              <p class="text-slate-600 text-sm">Total: <span data-stat="total_motoristas">{{ $total_motoristas }}</span></p>
            </div>
        ...
        <div class="mb-8">
          <h2 class="text-2xl font-bold text-white mb-4">Veículos</h2>
          <div class="flex justify-center gap-8 w-[100rem]">
            <div class="bg-white p-3 rounded shadow-2xs w-full min-h-full">
              ...
              <p class="text-slate-600 text-sm">Total: <span data-stat="total_veiculos">{{ $total_veiculos }}</span></p>
            </div>
        ...
        <div>
          <h2 class="text-2xl font-bold text-white mb-4">Rotas</h2>
          <div class="flex justify-center gap-8 w-[100rem]">
            <div class="bg-white p-3 rounded shadow-2xs w-full min-h-full">
            ...
            <div class="bg-white p-3 rounded shadow-2xs w-full min-h-full">
              ...
              <p class="text-slate-600 text-sm">Total: <span data-stat="total_rotas">{{ $total_rotas }}</span></p>
            </div>
          </div>
        </div>
